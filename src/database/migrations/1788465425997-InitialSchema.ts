...
export class InitialSchema1788465425997 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_deb97303a52b1c1829d9a29dee"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8bf6e3398d6c4089a47ab0ec9c"`);
        await queryRunner.query(`DROP TABLE "tb_stock_movements"`);
        await queryRunner.query(`DROP TYPE "public"."tb_stock_movements_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f185e497c778f7bf15679d9ea4"`);
        await queryRunner.query(`DROP TABLE "tb_production_order_items"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_05d5551ef65286d3a75d9a26b2"`);
        await queryRunner.query(`DROP TABLE "tb_production_orders"`);
        await queryRunner.query(`DROP TYPE "public"."tb_production_orders_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_225b8243c9553fd83c53ace235"`);
        await queryRunner.query(`DROP TABLE "tb_recipe_items"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a25b105b49741afa8c50b50e42"`);
        await queryRunner.query(`DROP TABLE "tb_recipes"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_453d1b8fb90a040659d8e0183d"`);
        await queryRunner.query(`DROP TABLE "tb_purchase_items"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_791a8c9b336d58f989aa6951a0"`);
        await queryRunner.query(`DROP TABLE "tb_purchases"`);
        await queryRunner.query(`DROP TYPE "public"."tb_purchases_discount_mode_enum"`);
        await queryRunner.query(`DROP TYPE "public"."tb_purchases_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_74ae6df01711c7868f166672ca"`);
        await queryRunner.query(`DROP TABLE "tb_sales_order_items"`);
        await queryRunner.query(`DROP TYPE "public"."tb_sales_order_items_product_kind_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_04be43eb0018493fdb53d5b81f"`);
        await queryRunner.query(`DROP TABLE "tb_sales_orders"`);
        await queryRunner.query(`DROP TYPE "public"."tb_sales_orders_discount_mode_enum"`);
        await queryRunner.query(`DROP TYPE "public"."tb_sales_orders_sales_channel_enum"`);
        await queryRunner.query(`DROP TYPE "public"."tb_sales_orders_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6572595082612eca75a844c243"`);
        await queryRunner.query(`DROP TABLE "tb_sessions"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c6d5621a73113a7d2f66c1a30a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_31e5d547562300297bb04fc0e3"`);
        await queryRunner.query(`DROP TABLE "tb_store_memberships"`);
        await queryRunner.query(`DROP TYPE "public"."tb_store_memberships_role_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f528ec1a1e112d34fbf99f5567"`);
